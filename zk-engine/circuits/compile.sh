...
snarkjs powersoftau contribute pot12_0.ptau pot12_1.ptau --name="SAK" -v -e="sak entropy" # NOTE: Deterministic entropy — acceptable for hackathon demo. Use random entropy for production.
...
snarkjs zkey contribute circuit_0.zkey circuit_final.zkey --name="SAK Final" -v -e="final entropy" # NOTE: Same as above.
